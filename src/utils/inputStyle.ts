export const componentsStyle = {
    ...
    label : "flex items-center justify-center text-sm min-w-[120px] bg-[#58cbff] text-center h-full rounded-l-xl text-white font-bold text-shadow-custom-labels",
    input : "w-full p-2 h-full bg-[#ecf0f3] transition-all duration-200 ease-in-out text-gray-500 font-light tracking-[0.15px] border-none text-shadow-custom outline-none rounded-r-xl shadow-[inset_2px_2px_4px_#d1d9e6,inset_-2px_-2px_4px_#f9f9f9] focus:shadow-[inset_4px_4px_4px_#d1d9e6,inset_-4px_-4px_4px_#f9f9f9]",
